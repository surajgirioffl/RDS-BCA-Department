...
class Otp(Base):
    ...
    creation_time = mapped_column(DateTime, nullable=False, server_default="CURRENT_TIMESTAMP")
...
class OtpLog(Base):
    ...
    logged_time = mapped_column(DateTime, nullable=False, server_default="CURRENT_TIMESTAMP")
